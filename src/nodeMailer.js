...
const sendEmail = async (email, subject, token, id, text) => {
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject,
      html: `<p>You requested for reset password, kindly use this <a href="https://delivery-app-oleksenko.herokuapp.com/reset-password/${token}/${id}">link</a> to reset your password</p>`,
    });
